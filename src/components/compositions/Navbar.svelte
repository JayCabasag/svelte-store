...
<nav class="sticky top-0 h-[60px] bg-green-500 w-full flex items-center justify-center">
	<div class="w-full max-w-[1440px] flex justify-between items-center px-[15px]">
		<div>
			<h1 class="leading-[60px] font-bold text-white text-2xl">Store logo</h1>
		</div>
		<div class="h-[60px] flex items-center justify-center">
			<CartPanel {openCartPanel} on:toggle={handleToggleCartPanel} />
			<button class="relative" on:click={handleToggleCartPanel}>
				<CartQuantity />
				<svg
					width="45px"
					height="45px"
